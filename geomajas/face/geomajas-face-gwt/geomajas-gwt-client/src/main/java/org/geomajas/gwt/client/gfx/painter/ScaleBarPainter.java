...
/**
 * <p>
 * Painter implementation for {@link ScaleBar}.
 * </p>
 * 
 * @author Frank Wynants
 */
public class ScaleBarPainter implements Painter {
	...
	public String getPaintableClassName() {
		return ScaleBar.class.getName();
	}

	/**
	 * The actual painting function. Draws the composites with the object's id.
	 * 
	 * @param object
	 *            A {@link ScaleBar} object.
	 * @param graphics
	 *            A GraphicsContext object, responsible for actual drawing.
	 */
	public void paint(Paintable paintable, GraphicsContext graphics) {
		// ScaleBar extends Composite which exists of other objects that all have their own paint method
	}
