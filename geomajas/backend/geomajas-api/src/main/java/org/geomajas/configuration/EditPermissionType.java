...
public class EditPermissionType implements Serializable {
	...
	private boolean creatingAllowed;

	private boolean updatingAllowed;

	private boolean deletingAllowed;

	public EditPermissionType() {
	}

	public boolean isCreatingAllowed() {
		return creatingAllowed;
	}

	public void setCreatingAllowed(boolean creatingAllowed) {
		this.creatingAllowed = creatingAllowed;
	}

	public boolean isUpdatingAllowed() {
		return updatingAllowed;
	}

	public void setUpdatingAllowed(boolean updatingAllowed) {
	...
	public void setDeletingAllowed(boolean deletingAllowed) {
