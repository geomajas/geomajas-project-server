 ...
 */
public interface TileCacheService {

	/**
	 * Get a filled <code>RenderContent</code> object from a
	 * <code>HttpServletRequest</code> object which does not contain the image.
	 * This will retrieve the requested
	 ...
	 * @throws org.geomajas.cache.CacheException caching problem
	 */
	RenderContent get(RenderContent renderContent) throws CacheException;
}
