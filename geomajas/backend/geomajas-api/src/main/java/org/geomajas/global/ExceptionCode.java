...
public interface ExceptionCode {
	...
	//int IMAGE_RENDERING_LAYER_PROBLEM = 1; @todo can be reused
	//int IMAGE_RENDERING_FILTER_PROBLEM = 2; @todo can be reused
	int MAP_MAX_EXTENT_MISSING = 3;
	int LAYER_CRS_PROBLEMATIC = 4;
	int LAYER_CRS_UNKNOWN_AUTHORITY = 5;
	int TRANSFORMER_CREATE_LAYER_TO_MAP_FAILED = 6;
	//int UNEXPECTED_END_OF_FEATURES = 7; @todo can be reused
	//int UNEXPECTED_FEATURE_WRITING_PROBLEM = 8; @todo can be reused
	int ATTRIBUTE_UNKNOWN = 9;
	//int CACHE_SIZE_IMMUTABLE_WHEN_IN_USE = 10; @todo can be reused
	//int CACHE_UNEXPECTED_FAILURE = 11; @todo can be reused
	//int CACHE_NOT_WRITABLE = 12; @todo can be reused
	//int CACHE_NO_STYLE_ID = 13; @todo can be reused
	//int CACHE_NO_LAYER_ID = 14; @todo can be reused
	//int CACHE_NO_LOCATION = 15; @todo can be reused
	//int CACHE_CANNOT_DELETE = 16; @todo can be reused
	//int CACHE_IO_EXCEPTION_ON_PATH = 17; @todo can be reused
	//int CACHE_CANNOT_CREATE_DIRECTORY = 18; @todo can be reused
	//int CACHE_INTERRUPTED_WHILE_WAITING_FOR_LOCK = 19; @todo can be reused
	int LAYER_NOT_FOUND = 20;
	//int CRS_NO_DEFAULT = 21; @todo can be reused
	//int CACHE_UNEXPECTED_ERROR_WHILE_WRITING = 22; @todo can be reused
	...
	//int RENDER_MAP_PROBLEM = 27; @todo can be reused
	...
	//int FILTER_APPLY_PROBLEM = 58; @todo can be reused
	...
	int RASTER_LAYER_NOT_FOUND = 76;
	int REFRESH_CONFIGURATION_FAILED = 77;
	int APPLICATION_NOT_FOUND = 78;
	int MAP_NOT_FOUND = 79;
}
