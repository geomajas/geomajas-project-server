...
public class SearchFeatureCommand implements CommandHasRequest<SearchFeatureRequest, SearchFeatureResponse> {
	...
	@Override
	public SearchFeatureRequest getEmptyCommandRequest() {
		return new SearchFeatureRequest();
	}
