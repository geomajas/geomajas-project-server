 ...
 */
dojo.provide("tutorial.DemoManager");

dojo.declare("DemoManager", ConfigManager, {
	...
	onConfigDone : function () {
		...
		var mapWidget = dijit.byId("sampleFutureMap");
		...
		var toolbar = dijit.byId("sampleFutureToolbar");
		...
		var layer = mapWidget.getMapModel().getLayerById("sampleFutureMap.cities");
