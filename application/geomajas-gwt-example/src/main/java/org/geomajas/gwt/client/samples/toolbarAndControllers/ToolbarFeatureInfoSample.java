...
public class ToolbarFeatureInfoSample extends SamplePanel {
	...
	public Canvas getViewPanel() {
		...
		// Map with ID wmsToolbarMap is defined in the XML configuration. (mapOsmFeatureInfo.xml)
	...
	public String getSourceFileName() {
		return "classpath:org/geomajas/gwt/client/samples/controller/ToolbarFeatureInfoSample.txt";
	}
