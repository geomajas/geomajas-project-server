...
package org.geomajas.example.gwt.client.samples.grid;
...
public class AttributeSearchSample extends SamplePanel {
	...
	public String getSourceFileName() {
		return "classpath:org/geomajas/gwt/client/samples/grid/AttributeSearchSample.txt";
	}

	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/gwt/samples/mapwidget/layerBeans.xml",
