 ...
 */
public class GetFeatureInfoPanel111 extends ContentPanel {
	 ...
	 * @author Pieter De Graef
	 */
	interface MyUiBinder extends UiBinder<Widget, GetFeatureInfoPanel111> {
	}
	...
	public String getTitle() {
		return "WMS 1.1.1 - GetFeatureInfo";
	}
