...
import org.geomajas.puregwt.example.client.sample.general.IntroductionContentPanel;
...
import org.geomajas.puregwt.example.client.sample.general.ServerErrorPanel;
...
public class ShowcaseTreeViewModel implements TreeViewModel {
	...
	private void initializeTree() {
		...
		catLayerMan.addExample(new LayerAddRemovePanel(geomajasInjector.getMapPresenter()), null);
