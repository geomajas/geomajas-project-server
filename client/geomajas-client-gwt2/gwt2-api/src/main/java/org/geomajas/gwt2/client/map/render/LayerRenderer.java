...
public interface LayerRenderer {
	...
	/**
	 * Add a handler for {@link org.geomajas.gwt2.client.ScaleLevelRenderedEvent}s. At some point after a call to the
	 * {@link #ensureScale(double, Bbox)} method, that particular scale level will be rendered (i.e. all tiles have
	 * arrived). These handlers will be notified of that event.
	 * 
	 * @param handler
	 *            The event handler.
