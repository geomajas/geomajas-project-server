...
public class AttributeCustomTypeSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/layerBeansCustomType.xml",
				"classpath:org/geomajas/smartgwt/example/context/mapBeansCustomType.xml" };
	}
