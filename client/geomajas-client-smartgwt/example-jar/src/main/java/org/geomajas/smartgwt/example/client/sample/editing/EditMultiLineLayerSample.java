...
public class EditMultiLineLayerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapEditMultiLineLayer.xml",
				"classpath:org/geomajas/smartgwt/example/context/layerRoadsTrl020-ML.xml" };
	}
