...
public class EditLineLayerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapEditLineLayer.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerRoadsTrl020.xml" };
	}
