...
public class AttributeIncludeInFormSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/layerBeansIncludeInForm.xml",
				"classpath:org/geomajas/smartgwt/example/context/mapBeansIncludeInForm.xml" };
	}
