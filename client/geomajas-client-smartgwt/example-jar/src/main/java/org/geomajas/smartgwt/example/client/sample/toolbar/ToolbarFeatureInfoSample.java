...
public class ToolbarFeatureInfoSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/base/layerCountries110m.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerWmsBluemarble.xml",
				"classpath:org/geomajas/smartgwt/example/context/mapFeatureInfo.xml" };
	}
