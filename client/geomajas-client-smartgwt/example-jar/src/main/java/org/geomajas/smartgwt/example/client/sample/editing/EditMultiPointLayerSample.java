...
public class EditMultiPointLayerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapEditMultiPointLayer.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerWmsBluemarble.xml",
				"classpath:org/geomajas/smartgwt/example/context/layerMultiCities.xml" };
	}
