...
package org.geomajas.smartgwt.example.client.sample.editing;
...
public class EditMultiPolygonLayerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapEditMultiPolygonLayer.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerWmsBluemarble.xml",
				"classpath:org/geomajas/smartgwt/example/context/layerLakes110mMP.xml" };
	}
