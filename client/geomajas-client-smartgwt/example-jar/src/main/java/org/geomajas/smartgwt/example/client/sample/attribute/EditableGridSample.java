...
public class EditableGridSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapEditableGrid.xml",
				"classpath:org/geomajas/smartgwt/example/context/layerBeansEditableGrid.xml"};
	}
