...
import org.geomajas.smartgwt.client.controller.MeasureDistanceController;
...
public class FallbackControllerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapToolbarSecurity.xml",
