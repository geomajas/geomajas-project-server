...
public class EditPointLayerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapEditPointLayer.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerWmsBluemarble.xml",
				"classpath:org/geomajas/smartgwt/example/context/layerAirports.xml" };
	}
