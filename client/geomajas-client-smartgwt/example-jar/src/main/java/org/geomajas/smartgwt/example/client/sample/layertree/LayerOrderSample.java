...
package org.geomajas.smartgwt.example.client.sample.layertree;
...
public class LayerOrderSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/smartgwt/example/context/mapLegend.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerLakes110m.xml",
				"classpath:org/geomajas/smartgwt/example/base/layerRivers50m.xml",
