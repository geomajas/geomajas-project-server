...
import org.geomajas.smartgwt.client.map.event.LayerDeselectedEvent;
import org.geomajas.smartgwt.client.map.event.LayerSelectedEvent;
import org.geomajas.smartgwt.client.map.event.LayerSelectionHandler;
...
import org.geomajas.smartgwt.client.widget.attribute.AttributeCriterionPane;
import org.geomajas.smartgwt.client.widget.event.SearchEvent;
import org.geomajas.smartgwt.client.widget.event.SearchHandler;
 ...
 * </p>
 * <p>
 * When a search has been executed, and a result is returned
 * from the server, a {@link org.geomajas.smartgwt.client.widget.event.SearchEvent} will be triggered. So in order to
 * do something with the result, add a {@link org.geomajas.smartgwt.client.widget.event.SearchHandler} to this widget.
 * Hint: There is a <code>DefaultSearchHandler</code> that displays the resulting set of features in a {@link
 * FeatureListGrid} widget.
 * </p>
 *
...
public class FeatureSearch extends Canvas {
	...
	/**
	 * <p>
	 * Add a handler for the {@link org.geomajas.smartgwt.client.widget.event.SearchEvent}. A search event,
	 * is the event that is triggered when the result of a search request successfully returns from the server. The
	 * list of features from that result will be present in that search event object.
	 * </p>
	 * <p>
