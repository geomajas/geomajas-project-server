 ...
 * button is used to set a new controller onto the {@link org.geomajas.smartgwt.client.widget.MapWidget}. If you are
 * looking for an action that should be executed immediately when clicking on it,
 * have a look at the {@link ToolbarAction} class.
 *
