...
public class FeatureAttributeEditor extends VLayout {
	 ...
	 * </p>
	 * <p>
	 * This constructor will use the {@link org.geomajas.smartgwt.client.widget.attribute.DefaultFeatureFormFactory}
	 * to create the actual attribute form. If you want a specific factory to be used instead,
