 ...
 * {@link org.geomajas.smartgwt.client.map.feature.FeatureTransaction} to see if there are any geometries that are
 * not valid. When an invalid geometry is found, an exception is thrown.
 * </p>
 *
