...
import org.geomajas.smartgwt.client.action.menu.DeselectAllAction;
import org.geomajas.smartgwt.client.action.menu.ToggleSelectionAction;
...
public class SelectionController extends AbstractRectangleController {
	 ...
	 *            that selected layer is a {@link org.geomajas.smartgwt.client.map.layer.VectorLayer}. In all other
	 *            cases, the selection toggle will occur on the first object that is encountered. In other words it
	 *            will depend on the layer drawing order, starting at the top.
	...
	public void onDeactivate() {
		...
		if (dragging) {
			dragging = false;
			mapWidget.render(rectangle, MapWidget.RenderGroup.SCREEN, MapWidget.RenderStatus.DELETE);
		}
	}
	 ...
	 * layer is a {@link org.geomajas.smartgwt.client.map.layer.VectorLayer}. In all other cases,
	 ...
	 * selected layer is a {@link org.geomajas.smartgwt.client.map.layer.VectorLayer}. In all other cases, the selection
	 * toggle will occur on the first object that is encountered. In other words it will depend on the layer drawing
