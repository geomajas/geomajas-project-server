...
/**
 * Event that reports when a {@link org.geomajas.smartgwt.client.map.MapModel} will be cleared.
 *
...
public class MapModelClearEvent extends GwtEvent<MapModelClearHandler> {
	...
	/**
	 * Get the {@link org.geomajas.smartgwt.client.map.MapModel} will be cleared.
	 *
	 * @return map model
	 */
