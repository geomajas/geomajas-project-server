...
public class FeatureEditor {
	...
	public FeatureTransaction startEditing(Feature[] oldFeatures, Feature[] targetFeatures) {
		...
		if (featureTransaction == null) {
			...
			handlerManager.fireEvent(new EditingEvent(EditingEvent.EditingEventType.START_EDITING));
	...
	public void stopEditing() {
		handlerManager.fireEvent(new EditingEvent(EditingEvent.EditingEventType.STOP_EDITING));
