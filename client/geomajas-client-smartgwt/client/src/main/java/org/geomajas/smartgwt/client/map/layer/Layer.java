 ...
 * paint layers on the map, it implements the {@link org.geomajas.smartgwt.client.gfx.PaintableGroup} interface.
 * </p>
 * 
 * @param <T>
...
public interface Layer<T extends ClientLayerInfo> extends PaintableGroup {
	...
	/**
	 * Forces this layer to update its style and notifies all
	 * {@link org.geomajas.smartgwt.client.map.event.LayerStyleChangedHandler}s.
	 */
	void updateStyle();
	...
	/**
	 * Add handlers for {@link org.geomajas.smartgwt.client.map.event.LayerChangedHandler}s. These events occur when
	...
	/**
	 * Add handlers for {@link org.geomajas.smartgwt.client.map.event.LayerStyleChangedHandler}s. These events occur
