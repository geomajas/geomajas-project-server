...
/**
 * <p> Abstraction of a <code>Paintable</code> object that has the ability to also be drawn in world space. Extensions
 * of this abstract class have the ability to be drawn in screen space as well as world space. </p> <p> See the {@link
 * org.geomajas.smartgwt.client.gfx.WorldPaintable} interface for more information on how to draw objects in world
 * space. This abstract implementation, facilitates the transformation of the location objects, while still storing the
 * original location object. </p>
 *
...
public abstract class AbstractWorldPaintable implements WorldPaintable {
	 ...
	 * using the pan group. Supports only {@link Coordinate}, {@link org.geomajas.smartgwt.client.spatial.Bbox} and
	 * {@link org.geomajas.smartgwt.client.spatial.geometry.Geometry} classes as location object.
	 *
