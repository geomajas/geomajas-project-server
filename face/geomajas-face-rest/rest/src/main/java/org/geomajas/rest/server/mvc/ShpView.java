...
import org.geomajas.rest.server.ShpParser;
 ...
 * @author Oliver May
 */
@Component("rest.server.mvc.ShpView")
public class ShpView extends AbstractView {

	@Autowired
	private GeoToolsConverterService convertorService;

	private ShpParser parser = new ShpParser();
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		if (Collection.class.isAssignableFrom(ff.getClass())) {
			...
			parser.write(coll, response.getOutputStream(), sft, (String) model.get(RestController.VECTOR_LAYER_ID));
		} else {
