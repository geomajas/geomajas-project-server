...
dojo.provide("geomajas.action.toolbar.RotateRightAction");
dojo.require("geomajas.action.ToolbarAction");

dojo.declare("RotateRightAction", ToolbarAction, {

	/**
	 * @fileoverview Rotate clockwise (DynamicToolbar).
	...
	constructor : function (id, mapView, angle) {
		...
		this.image = "rotateRightIcon";

		/** Reference to the tooltip. */
		this.tooltip = this.tooltipLocale.RotateRightAction;
