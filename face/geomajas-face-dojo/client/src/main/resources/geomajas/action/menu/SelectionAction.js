dojo.provide("geomajas.action.menu.SelectionAction");
/*
 ...
 */
dojo.declare("SelectionAction", Action, {
	 ...
	 */
	constructor : function (id, mapWidget, priorityToSelectedLayer, pixelTolerance) {
		/** @private */
