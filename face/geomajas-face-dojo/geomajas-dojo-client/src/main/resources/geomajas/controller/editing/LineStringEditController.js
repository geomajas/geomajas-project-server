...
dojo.provide("geomajas.controller.editing.LineStringEditController");
...
dojo.declare("LineStringEditController", MouseListener, {
	...
	constructor : function (parent, mapWidget) {
		...
		this.menuId = "lineStringEditMenu";
	...
	getName : function () {
		return "LineStringEditController";
	},
	...
	getStartIndex : function (lineString) {
		return [];
	},
	...
	_checkAppendGeometryValidity : function (featureTransaction, index, coordinate) {
		var lineString = featureTransaction.getNewFeatures()[index[0]].getGeometry().clone();
		var geometry = lineString.getGeometryN(index[1]);
	...
	_checkMoveGeometryValidity : function (featureTransaction, index, coordinate) {
		...
		this.editor.edit(lineString, operation)
		return lineString.isValid();
	},
