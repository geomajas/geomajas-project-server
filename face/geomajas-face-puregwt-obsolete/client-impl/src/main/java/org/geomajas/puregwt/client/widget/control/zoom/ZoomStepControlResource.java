...
public interface ZoomStepControlResource extends ClientBundle {
	...
	/** Zoom step background for the {@link org.geomajas.puregwt.client.widget.control.ZoomStepWidget}. */
	@Source("image/map-zoom-step.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource zoomStepControlStep();

	/** Zoom step handle for the {@link org.geomajas.puregwt.client.widget.control.ZoomStepWidget}. */
	@Source("image/map-zoom-step-handle.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource zoomStepControlHandle();

	/** Zoom step handle for the {@link org.geomajas.puregwt.client.widget.control.ZoomStepWidget} when highlighted. */
