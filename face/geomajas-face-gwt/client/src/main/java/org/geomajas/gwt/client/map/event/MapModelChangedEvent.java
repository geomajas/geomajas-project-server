...
/**
 * Event that reports all {@link org.geomajas.gwt.client.map.MapModel} changes.
 *
...
public class MapModelChangedEvent extends GwtEvent<MapModelChangedHandler> {
	...
	@Override
	protected void dispatch(MapModelChangedHandler mapViewHandler) {
		mapViewHandler.onMapModelChanged(this);
	}
}
