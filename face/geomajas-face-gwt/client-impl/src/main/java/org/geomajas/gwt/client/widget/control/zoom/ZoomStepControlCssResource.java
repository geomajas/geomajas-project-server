...
public interface ZoomStepControlCssResource extends CssResource {
	...
	/** The top style of the {@link org.geomajas.gwt.client.widget.control.zoom.ZoomStepControl}. */
	@ClassName("gm-ZoomStepControl")
	String zoomStepControl();

	/** Zoom in button in the {@link org.geomajas.gwt.client.widget.control.zoom.ZoomStepControl}. */
	@ClassName("gm-ZoomStepControl-zoomIn")
	String zoomStepControlZoomIn();

	/** Zoom out button in the {@link org.geomajas.gwt.client.widget.control.zoom.ZoomStepControl}. */
	@ClassName("gm-ZoomStepControl-zoomOut")
	String zoomStepControlZoomOut();

	/** Zoom steps parent DIV in the {@link org.geomajas.gwt.client.widget.control.zoom.ZoomStepControl}. */
	@ClassName("gm-ZoomStepControl-steps")
	String zoomStepControlSteps();

	/** Zoom step style in the {@link org.geomajas.gwt.client.widget.control.zoom.ZoomStepControl}. */
	@ClassName("gm-ZoomStepControl-step")
	String zoomStepControlStep();

	/** Zoom step handle style in the {@link org.geomajas.gwt.client.widget.control.zoom.ZoomStepControl}. */
