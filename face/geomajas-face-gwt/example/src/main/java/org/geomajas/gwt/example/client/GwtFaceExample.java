...
import org.geomajas.gwt.example.client.samples.attribute.AttributeCustomFormSample;
import org.geomajas.gwt.example.client.samples.attribute.AttributeCustomTypeSample;
import org.geomajas.gwt.example.client.samples.attribute.AttributeIncludeInFormSample;
import org.geomajas.gwt.example.client.samples.attribute.AttributeSearchSample;
import org.geomajas.gwt.example.client.samples.attribute.EditAttributeSample;
import org.geomajas.gwt.example.client.samples.attribute.EditableGridSample;
import org.geomajas.gwt.example.client.samples.attribute.FeatureListGridSample;
import org.geomajas.gwt.example.client.samples.attribute.SearchSample;
import org.geomajas.gwt.example.client.samples.controller.CircleControllerSample;
import org.geomajas.gwt.example.client.samples.controller.ControllerOnElementSample;
import org.geomajas.gwt.example.client.samples.controller.CustomControllerSample;
import org.geomajas.gwt.example.client.samples.controller.FallbackControllerSample;
import org.geomajas.gwt.example.client.samples.controller.MouseMoveListenerSample;
import org.geomajas.gwt.example.client.samples.controller.MultipleListenersSample;
import org.geomajas.gwt.example.client.samples.controller.RectangleControllerSample;
import org.geomajas.gwt.example.client.samples.editing.EditLineLayerSample;
import org.geomajas.gwt.example.client.samples.editing.EditMultiLineLayerSample;
import org.geomajas.gwt.example.client.samples.editing.EditMultiPolygonLayerSample;
import org.geomajas.gwt.example.client.samples.editing.EditPointLayerSample;
import org.geomajas.gwt.example.client.samples.editing.EditPolygonLayerSample;
import org.geomajas.gwt.example.client.samples.general.ServerErrorSample;
import org.geomajas.gwt.example.client.samples.i18n.SampleMessages;
import org.geomajas.gwt.example.client.samples.layer.OpenStreetMapSample;
import org.geomajas.gwt.example.client.samples.layertree.LayerOrderSample;
import org.geomajas.gwt.example.client.samples.layertree.LayertreeSample;
import org.geomajas.gwt.example.client.samples.layertree.LegendSample;
import org.geomajas.gwt.example.client.samples.mapwidget.CrsSample;
import org.geomajas.gwt.example.client.samples.mapwidget.LayerOpacitySample;
import org.geomajas.gwt.example.client.samples.mapwidget.MaxBoundsToggleSample;
import org.geomajas.gwt.example.client.samples.mapwidget.NavigationSample;
import org.geomajas.gwt.example.client.samples.mapwidget.OverviewMapSample;
import org.geomajas.gwt.example.client.samples.mapwidget.PanScaleToggleSample;
import org.geomajas.gwt.example.client.samples.mapwidget.RenderingSample;
import org.geomajas.gwt.example.client.samples.mapwidget.UnitTypesSample;
import org.geomajas.gwt.example.client.samples.mapwidget.WorldScreenSample;
import org.geomajas.gwt.example.client.samples.toolbar.CustomToolbarSample;
import org.geomajas.gwt.example.client.samples.toolbar.CustomToolbarToolsSample;
import org.geomajas.gwt.example.client.samples.toolbar.ScaleSelectCustomSample;
import org.geomajas.gwt.example.client.samples.toolbar.ScaleSelectDefaultSample;
import org.geomajas.gwt.example.client.samples.toolbar.ToolbarFeatureInfoSample;
import org.geomajas.gwt.example.client.samples.toolbar.ToolbarMeasureSample;
import org.geomajas.gwt.example.client.samples.toolbar.ToolbarNavigationSample;
import org.geomajas.gwt.example.client.samples.toolbar.ToolbarSelectionSample;
