...
public class SearchLayersByPointCommand 
	implements Command<SearchLayersByPointRequest, SearchByLocationResponse> {
	...
	public void execute(SearchLayersByPointRequest request, SearchByLocationResponse response) 
	throws Exception {
