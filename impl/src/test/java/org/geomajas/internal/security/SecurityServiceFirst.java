...
/**
 * Security service which accepts "TEST" as token, used for testing the security manager service.
 *
 * @author Joachim Van der Auwera
 */
public class SecurityServiceFirst implements SecurityService {
	public String getId() {
		return "FIRST";
	}
