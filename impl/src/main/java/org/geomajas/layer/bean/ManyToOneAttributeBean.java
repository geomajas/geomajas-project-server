...
public class ManyToOneAttributeBean {
	...
	public boolean equals(Object obj) {
		...
		ManyToOneAttributeBean other = (ManyToOneAttributeBean) obj;
	...
	public String toString() {
		return "ManyToOneAttributeBean [id=" + id + ", booleanAttr=" + booleanAttr + ", currencyAttr=" + currencyAttr
