...
import org.geomajas.puregwt.widget.example.client.sample.LayerLegendPanelSample;
import org.geomajas.puregwt.widget.example.client.sample.LegendDropDownWidgetSample;
	...
	private void registerSamples() {
		...
		SamplePanelRegistry.registerFactory(CATEGORY_WIDGET, new ShowcaseSampleDefinition() {
			...
			public SamplePanel create() {
				return new LayerLegendPanelSample();
			}
		...
		SamplePanelRegistry.registerFactory(CATEGORY_WIDGET, new ShowcaseSampleDefinition() {
			...
			public SamplePanel create() {
				return new LegendDropDownWidgetSample();
			}
