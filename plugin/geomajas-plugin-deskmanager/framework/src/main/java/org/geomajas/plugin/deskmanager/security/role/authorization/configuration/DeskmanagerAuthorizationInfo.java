 ...
 * conditions: 
 * <ul>
 * <li>commandsInclude contains the command (or a wildcard matching the command) 
 * <b>AND</b>
 * <li>commandsExclude does not contain the command (or a wildcard matching the command)
 * </ul>
 * </p>
 * So you may configure a limited list of commands that can be executed by only providing commandsInclude and 
 * a limited list of commands that may never be executed by provide a .* wildcard in commandsInclude, and put all 
 * excluded commands in commandsExclude. <br /> Putting a .* wildcard in commandsExclude will always exclude all commands.
 * <p>
