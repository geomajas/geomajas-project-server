...
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.ChooseTypeStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.EditLayerSettingsStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.ShapefileUploadStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.VectorChooseLayerStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.VectorEditLayerAttributesStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.VectorEditLayerStyleStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.WfsCapabilitiesStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.WmsCapabilitiesStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.WmsChooseLayerStep;
import org.geomajas.plugin.deskmanager.client.gwt.manager.beheer.datalayers.steps.WmsPreviewLayerStep;
