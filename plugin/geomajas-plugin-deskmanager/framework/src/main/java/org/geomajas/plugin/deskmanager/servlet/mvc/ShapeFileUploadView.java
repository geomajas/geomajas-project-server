 ...
 */
@Component(ShapeFileUploadView.VIEW_NAME)
public class ShapeFileUploadView extends AbstractView {

	public static final String VIEW_NAME = "ShapeFileUploadView";
