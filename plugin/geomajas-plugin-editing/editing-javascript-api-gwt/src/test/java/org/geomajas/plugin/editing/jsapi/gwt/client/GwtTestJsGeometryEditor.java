 ...
 */
public class GwtTestJsGeometryEditor extends GWTTestCase {

	@Override
	public String getModuleName() {
		// return "org.geomajas.plugin.editing.jsapi.EditingJavascriptApi";
		return "org.geomajas.plugin.editing.jsapi.gwt.EditingJsApi";
	}
	...
	/*-{
		...
		var editor = new $wnd.org.geomajas.plugin.editing.GeometryEditor();
		var foobar = new $wnd.org.geomajas.Foobar();
