...
package org.geomajas.plugin.editing.gwt.example.client.multigeom;
 ...
 */
public class MultiGeometryTab extends Tab {

	private final GeometryEditor editor;

	private final MapWidget map;

	public MultiGeometryTab() {
		super("Multi geometries");
		map = new MapWidget("mapEditing2", "app");
		...
		toolStrip.addMenuButton(getEditGeometryButton());
