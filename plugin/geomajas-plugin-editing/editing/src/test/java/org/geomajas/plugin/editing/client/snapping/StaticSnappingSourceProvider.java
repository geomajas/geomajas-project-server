 ...
 */
public class StaticSnappingSourceProvider implements SnappingSourceProvider {

	private Geometry[] geometries;

	public StaticSnappingSourceProvider() {
	...
	public StaticSnappingSourceProvider(Geometry[] geometries) {
		this.geometries = geometries;
	}

	public void getSnappingSources(GeometryArrayCallback callback) {
