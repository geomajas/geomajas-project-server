...
public class GeometryEditDeleteEvent extends GeometryEditEvent<GeometryEditOperationHandler> {

	public GeometryEditDeleteEvent(Geometry geometry, List<GeometryIndex> indices) {
	...
	protected void dispatch(GeometryEditOperationHandler geometryEditOperationHandler) {
		geometryEditOperationHandler.onGeometryEditDelete(this);
	}
}