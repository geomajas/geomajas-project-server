...
public class GeometryEditMarkForDeletionEndEvent extends GeometryEditEvent<GeometryEditMarkForDeletionHandler> {

	public GeometryEditMarkForDeletionEndEvent(Geometry geometry, List<GeometryIndex> indices) {
	...
	protected void dispatch(GeometryEditMarkForDeletionHandler geometryEditMarkForDeletionHandler) {
		geometryEditMarkForDeletionHandler.onMarkForDeletionEnd(this);
	}
}