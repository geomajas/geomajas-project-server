...
public class GeometryEditStopEvent extends GwtEvent<GeometryEditWorkflowHandler> {
	...
	@Override
	protected void dispatch(GeometryEditWorkflowHandler mapInitializationHandler) {
		mapInitializationHandler.onGeometryEditStop(this);
	}
