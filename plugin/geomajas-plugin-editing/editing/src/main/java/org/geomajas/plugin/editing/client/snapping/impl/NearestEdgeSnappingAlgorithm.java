...
package org.geomajas.plugin.editing.client.snapping.impl;
 ...
 * well. As you might guess, this is a heavier calculation then the {@link NearestVertexSnappingAlgorithm}. It tries to
 * calculate distances between the given coordinate, and any of the edges (one-by-one) and decides on the shortest.
 * </p>
 * 
 * @author Pieter De Graef
 */
public class NearestEdgeSnappingAlgorithm implements SnappingAlgorithm {
