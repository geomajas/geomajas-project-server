...
import org.geomajas.plugin.editing.client.snapping.SnappingSourceProvider.GeometryArrayCallback;
 ...
 * snappng will never occur. It is also possible to add a handler to listen to snapping events.
 * 
...
public class SnappingService {
	...
	public void update(Bbox mapBounds) {
		for (final SnappingRule condition : rules) {
			...
			condition.getSourceProvider().getSnappingSources(new GeometryArrayCallback() {
	 ...
	 */
	public void addSnappingRule(SnappingAlgorithm algorithm, SnappingSourceProvider sourceProvider, double distance,
	 ...
	 * @author Pieter De Graef
	 */
	private class SnappingRule {

		private final SnappingAlgorithm algorithm;
		...
		SnappingRule(SnappingAlgorithm algorithm, SnappingSourceProvider sourceProvider, double distance,
				boolean highPriority) {
		...
		public SnappingAlgorithm getAlgorithm() {
			return algorithm;
		}

		public SnappingSourceProvider getSourceProvider() {
