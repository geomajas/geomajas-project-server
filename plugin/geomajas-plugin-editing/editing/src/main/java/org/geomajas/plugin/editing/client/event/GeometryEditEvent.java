...
public abstract class GeometryEditEvent<H extends EventHandler> extends GwtEvent<H> {

	private Geometry geometry;

	private List<GeometryIndex> indices;

	public GeometryEditEvent(Geometry geometry, List<GeometryIndex> indices) {
