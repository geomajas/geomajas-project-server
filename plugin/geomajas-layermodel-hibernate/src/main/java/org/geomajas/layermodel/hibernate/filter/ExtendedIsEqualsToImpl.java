...
package org.geomajas.layermodel.hibernate.filter;
 ...
 * ???
 * 
 * @deprecated We should switch this class to opengis filters. It has many errors, so I commented out most of it...
 * @author Pieter De Graef
 */
@Deprecated
public class ExtendedIsEqualsToImpl extends IsEqualsToImpl {

	public ExtendedIsEqualsToImpl(FilterFactory factory, Expression expression1, Expression expression2,
			boolean matchCase) {
...
//		}
//
//		// Extension: When value1 is an array and value2 is not, we check
//		// every instance in the array against value2.
//		if (value1 instanceof Object[] && !(value2 instanceof Object[])) {
//			Object[] array = (Object[]) value1;
//			for (int i = 0; i < array.length; i++) {
//				if (array[i] != null
//						&& (array[i].equals(value2) || array[i].toString().equals(value2.toString()))) {
//					return true;
//				}
//			}
//		}
...
//
//		/*
//		 * For the following "if (value1.equals(value2))" line, we do not check
//		 * for "value1.getClass().equals(value2.getClass())" because:
//		 * 
//		 * 1) It is usually done inside the 'Object.equals(Object)' method, so
//		 * our check would be redundant. 2) It would lead to a subtile issue
//		 * with the 0.0 floating point value, as explained below.
//		 * 
//		 * Even if 'value1' and 'value2' are of the same class, we can not
//		 * implement this code as "return value1.equals(value2)" because a
//		 * 'false' value doesn't means that the values are numerically
//		 * different. Float and Double.equals(Object) return 'false' when
//		 * comparing +0.0 with -0.0, while +0.0 == -0.0 returns 'true'. We would
//		 * need to make a special case for them. It is better to fallback on the
//		 * more generic code following the "if" block in order to ensure
//		 * consistent behavior.
//		 */
...
//		}
//
//		// if we are doing delayed evaluation of a literal, try conversions to
//		// the actual info
...
//			final long lg1, lg2; // 'lg2' will not be initialized if not
//			// needed.
