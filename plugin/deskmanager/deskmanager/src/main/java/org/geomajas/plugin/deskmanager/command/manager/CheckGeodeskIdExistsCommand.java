...
/**
 * Command that checks if a geodesk id already exists in the database. Typically called when an administrator tries to
 * override a geodesk id in the management interface.
 * 
 * @author Oliver May
