...
public class ExampleDatabaseProvisioningServiceImpl implements DeskmanagerExampleDatabaseProvisioningService {
	...
	/*private static final String BE = "POLYGON ((553702.181679138331674 6705753.988936071284115,624165.707162118284032 "
	...
	private static final String NL = "POLYGON ((666654.367397028952837 6773340.011113058775663,685356.050909590441734 "
	...
	private static final String DE = "POLYGON ((1104501.56431816262193 7358587.663925886154175,1106468.951510177226737 "
	...
	/*replaced above with below ny Oliver May. Some problems with size of Geometry as it is saved in database:
	value is too long: GEOMETRY VARCHAR(255)  */
	...
	public void createData() throws WktException, GeomajasException {
		...
		User user = new User();
		user.setActive(true);
		user.setEmail("niko.haak@gmail.com");
		user.setName("niko");
