...
public class GetRasterLayerConfigCommandTest extends LoginBeforeTestingWithPredefinedProfileBase {
	...
	public void testGetDynamicWmsLayerConfiguration() throws Exception {
		...
		GetRasterLayerConfigResponse response = (GetRasterLayerConfigResponse) dispatcher
				.execute(GetRasterLayerConfigRequest.COMMAND, request, getTokenOfLoggedInBeforeTesting(), "en");
	...
	public void testNotAllowed() {
		CommandResponse response = dispatcher.execute(GetRasterLayerConfigRequest.COMMAND,
				new GetRasterLayerConfigRequest(), getToken(Role.GUEST), "en");
