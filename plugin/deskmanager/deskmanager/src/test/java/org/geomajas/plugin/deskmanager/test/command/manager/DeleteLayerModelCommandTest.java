...
public class DeleteLayerModelCommandTest extends LoginBeforeTestingWithPredefinedProfileBase {
	...
	public void testDeleteLayerModel() throws Exception {
		...
		CommandResponse response = dispatcher.execute(DeleteLayerModelRequest.COMMAND, request,
