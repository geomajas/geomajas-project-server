 ...
 */
@XmlRootElement
public class RasterLayerComponent extends BaseLayerComponent {
	...
	private final Logger log = LoggerFactory.getLogger(RasterLayerComponent.class);

	public RasterLayerComponent() {
