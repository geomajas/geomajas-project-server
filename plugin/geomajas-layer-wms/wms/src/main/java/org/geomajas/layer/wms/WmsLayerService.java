...
/**
 * <p>
 * Service used by WMS layers for painting etc.
 * </p>
 * 
...
public interface WmsLayerService {
	 ...
	 *             oops
	 */
	List<RasterTile> paint(WmsLayer layer, CoordinateReferenceSystem targetCrs, Envelope bounds, double scale)
			throws GeomajasException;
	 ...
	 */
	void calculateResolutions(WmsLayer layer);
}